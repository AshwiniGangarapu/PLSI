...
public class SeleniumUIUtils {
	...
	public SeleniumUIUtils(WebDriver driver) {// constructor which takes driver as parameter from test script init class
	...
	public void sendkeyboardKeysEnter(By element) {
	 ...
	 * 
	 * 
	 * WebElement ele = wait.doWaitForElement(element, driver); ele.click();
	 * ele.clear(); Integer.toString(); ele.sendKeys(value);
	 * 
	 * }
	 */
	...
	public void selectDropDownByValueUsingAttribute(By elements, String value, String keyAttribute) {
		...
		List<WebElement> dropdown = getElements(elements);// getElements is the method in same class so we can call
		// directly.
